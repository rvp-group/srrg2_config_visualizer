...
util::BlueprintNodeBuilder::BlueprintNodeBuilder(ImTextureID texture,
  ...
  HasHeader(false),
  HeaderColor(IM_COL32(200, 60, 60, 255)) {
}
...
void util::BlueprintNodeBuilder::End() {
  ...
  if (ImGui::IsItemVisible()) {
    ...
    if (!HeaderRect.is_empty()) {
      drawList->AddRectFilled(to_imvec(HeaderRect.top_left()) -
                                ImVec2(8 - halfBorderWidth, 4 - halfBorderWidth),
    ...
    //    drawList->AddRect(
    //      to_imvec(NodeRect.top_left()), to_imvec(NodeRect.bottom_right()), IM_COL32(255, 0, 0,
    //      255));
    //    drawList->AddRect(to_imvec(HeaderRect.top_left()),
    //                      to_imvec(HeaderRect.bottom_right()),
    //                      IM_COL32(0, 255, 0, 255));
    //    drawList->AddRect(to_imvec(ContentRect.top_left()),
